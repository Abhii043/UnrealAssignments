...
//void AVerticalRailActor::GenerateFence() {
//	GenerateCube(SectionIdx, { length, width, Height }, { 0, 0, 0 });
//
//	switch (Railing) {
//	case ERailingType::WindsorTurnedCapital:
//		GenerateBellShape(SectionIdx, width/3, Height/100 , width/10, 1, 10, 10);
//		GenerateSphere(SectionIdx, (width/2) + 0.5, 25, 25);
...
//		GenerateBellShape(SectionIdx, width / 3, Height / 100, width / 10, 1, 10, 10);
//		GenerateOval(SectionIdx, (width / 2) + 0.5, 25, 25);
//		break;
//	case ERailingType::GothicstarTop:
//		GenerateCubePyramid(SectionIdx, { 15, 15, 10 });
//		break;
//	case ERailingType::PyramidTop:
//		GenerateCube(SectionIdx, { width*0.75,  width * 0.75, Height/200 }, { 0, 0, 100.5 });
//		GenerateCube(SectionIdx, { width, width, Height/20 }, { 0, 0, 106 });
//		GeneratePyramid(SectionIdx, { width, width, Height / 20 }, { 0,0,116 });
//		break;
//	}
//	SectionIdx = 0;
//}
...
void AVerticalRailActor::GenerateFenceRailing(float length, float width, float height)
{
	...
	switch (Railing) {
	case ERailingType::WindsorTurnedCapital:
		GenerateCube(SectionIdx, { length, width, height/100 }, { 0, 0, (height + height/100)/2 });
		GenerateBellShape(SectionIdx, Diameter /3, height/100, Diameter /10, 1, 10, 10, { 0, 0, height/2 + height/100 });
		GenerateSphere(SectionIdx, Diameter/2, 25, 25, { 0, 0,  height / 2 + height / 50 + Diameter /2 });
		GenerateCurvedCone(SectionIdx, 16, 16, Diameter /5, height/40, { 0, 0,  height / 2 + height / 50 + Diameter - 2});
		break;
	case ERailingType::RoundTurnedCapital:
		GenerateCube(SectionIdx, { length, width, height/100 }, { 0, 0, (height + height / 100) / 2 });
		GenerateBellShape(SectionIdx, (Diameter / 3),( height / 100),( Diameter / 10), 1, 10, 10, { 0, 0, (height / 2) + (height / 100) });
	...
	case ERailingType::AcornCapital:
		GenerateCube(SectionIdx, { length, width, height / 100 }, { 0, 0, (height + height / 100) / 2 });
		GenerateBellShape(SectionIdx, Diameter / 3, height / 100, Diameter / 10, 1, 10, 10, { 0, 0, height / 2 + height / 100 });
		GenerateOval(SectionIdx, Diameter / 2, 25, 25, { 0, 0, (height / 2) + (height / 50) + ( Diameter * 1.5) / 2 });
		break;
	case ERailingType::GothicStarTop:
		GenerateCube(SectionIdx, { length * (3 / 4),  width * (3 / 4), height / 200 }, { 0, 0,(height + (height / 200)) / 2 });
		GenerateCubePyramid(SectionIdx, { length, width, height / 20 }, { 0, 0, (height + (height / 20)) / 2 + (height / 200) });
		GenerateSidePyramidsLeft(SectionIdx, { length/2, width, height/20 }, { length/4, 0, (height + (height / 20)) / 2 + (height / 200) + (height/20) });
		GenerateSidePyramidsRight(SectionIdx, { length/2, width, height/20 }, { -length/4, 0, (height + (height / 20)) / 2 + (height / 200) + (height/20) });
		break;
	case ERailingType::RoundedOverTop:
		GenerateCube(SectionIdx, { length * (3 / 4),  width * (3 / 4), height / 200 }, { 0, 0,(height + (height / 200)) / 2 });
		GenerateCube(SectionIdx, { length, width, height / 20 }, { 0, 0, (height + (height / 20)) / 2 + (height / 200) });
	...
	case ERailingType::RoundedStarTop:
		...
		GenerateSemiCircle(SectionIdx, length / 2, 1, { 0, -width / 2, (height) / 2 + (height / 200) + (height / 20) });
		GenerateSemiCircle(SectionIdx, length / 2, 0, { 0, width / 2, (height) / 2 + (height / 200) + (height / 20) });
		GenerateExtraLeft(SectionIdx, length / 2, width, 32, { 0, 0, (height) / 2 + (height / 200) + (height / 20) });
		GenerateExtraRight(SectionIdx, length / 2, width, 32, { 0, 0, (height) / 2 + (height / 200) + (height / 20) });
		break;
	case ERailingType::PyramidTop:
		GenerateCube(SectionIdx, { length * (3 / 4),  width * (3 / 4), height / 200 }, { 0, 0,(height + (height / 200)) / 2 });
		GenerateCube(SectionIdx, { length, width, height / 20 }, { 0, 0, (height + (height / 20)) / 2 + (height / 200) });
		GeneratePyramid(SectionIdx, { length, width, height / 20 }, { 0, 0, (height + (height/20))/2 + (height/200) + (height/20)});
		break;
	}
	SectionIdx = 0;
}
...
void AVerticalRailActor::GenerateExtraLeft(int32& SectionIndex, const float& Radius, const float& Height, const int32& Segments, const FVector& LocationOffset) {
...
void AVerticalRailActor::GenerateExtraRight(int32& SectionIndex, const float& Radius, const float& Height, const int32& Segments, const FVector& LocationOffset) {
	Vertices.Reset();
	Triangles.Reset();
	Normals.Reset();
	UVs.Reset();
